...
let graphs =
[
    new Graph("../Grafikai/1 lygis (1.0).png", "Lygis 1.0", -10, 11, 1, ["40%", "7px", "4.15px", "19% 34%", ""], [-4, 6], "-4; 6", 1, "[]"),
    new Graph("../Grafikai/1 lygis (1.1).png", "Lygis 1.1", -12, 13, 1, ["47%", "6px", "0.55px", "52% 32%", ""], [-3, 2], "-3; 2", 1, "[]"),
    new Graph("../Grafikai/1 lygis (1.2).png", "Lygis 1.2", -11, 10, 1, ["65%", "16px", "4.8px", "39.5% 20%", ""], [-8, 4], "-8; 4", 1, "[]"),
    new Graph("../Grafikai/2 lygis (2.0).png", "Lygis 2.0", -10, 11, 1, ["48%", "20px", "3.95px", "58% 29%", ""], [-5, 5], "[-5; 5]", 1, "[]"),
    new Graph("../Grafikai/2 lygis (2.1).png", "Lygis 2.1", -9, 9, 1, ["57%", "15px", "8.85px", "32% 48%", ""], [0, 9], "[0; 9]", 1, "[]"),
    new Graph("../Grafikai/2 lygis (2.2).png", "Lygis 2.2", -8, 7, 1, ["52.5%", "6px", "15.65px", "30% 25%", ""], [-0.5, 0.3], "[-0,5; 0,3]", 10, "[]"),
    new Graph("../Grafikai/3 lygis (3.0).png", "Lygis 3.0", -7, 9, 1, ["57.5%", "-6px", "14.8px", "15% 33%", ""], [-1, 1], "(-1; 1]", 1, "(]"),
    new Graph("../Grafikai/3 lygis (3.1).png", "Lygis 3.1", -9, 12, 1, ["56%", "25px", "4.1px", "27% 22%", ""], [-6, 7], "(-6; 7)", 1, "()"),
    new Graph("../Grafikai/3 lygis (3.2).png", "Lygis 3.2", -55, 60, 5, ["50.5%", "17px", "2.1px", "51% 17%", ""], [-40, 20], "(-40; 20)", 1, "()"),
    new Graph("../Grafikai/4 lygis (4.0.1).png", "Lygis 4.0.1", -9, 10, 1, ["75%", "-19px", "7.15px", "7% 36%", ""], ["-∞", 2], "(-∞; 2)", 1, "()"),
    new Graph("../Grafikai/4 lygis (4.0.2).png", "Lygis 4.0.2", -9, 12, 1, ["55%", "-33px", "5.6px", "37% 45.5%", ""], [0, "+∞"], "[0; +∞)", 1, "[)"),
    new Graph("../Grafikai/4 lygis (4.1).png", "Lygis 4.1", -9, 10, 1, ["83.5%", "-31px", "7.9px", "10% 39%", ""], ["-∞", 2], "(-∞; 2]", 1, "(]"),
    new Graph("../Grafikai/4 lygis (4.2).png", "Lygis 4.2", -12, 16, 1, ["78%", "-14px", "-2.8px", "5% 20%", ""], ["-∞", "+∞"], "(-∞; +∞)", 1, "()"),
    new Graph("../Grafikai/5 lygis (5.0).png", "Lygis 5.0", -45, 45, 5, ["29.5%", "-42px", "9.65px", "15.7% 49%", ""], [-10, 30], "g[-10; 30)", 1, "[)"),
    new Graph("../Grafikai/5 lygis (5.1).png", "Lygis 5.1", -12, 10, 1, ["62%", "-8px", "2.85px", "13% 47%", ""], ["-∞", 4], "h(-∞; 4]", 1, "(]"),
    new Graph("../Grafikai/5 lygis (5.2).png", "Lygis 5.2", -9, 13, 1, ["59.5%", "-5px", "2.95px", "38% 27%", ""], [-6, 9], "t(-6; 9]", 1, "(]"),
    new Graph("../Grafikai/6 lygis (6.0).png", "Lygis 6.0", -9, 9, 1, ["18%", "-9px", "9.05px", "25% 44%", ""], [-3, 3], "D(h)=[-3; 3]", 1, "[]"),
    new Graph("../Grafikai/6 lygis (6.1).png", "Lygis 6.1", -20, 8, 2, ["73.5%", "-63px", "20.5px", "15% 47%", ""], [-10, -2], "D(g)=[-10; -2]", 1, "[]"),
    new Graph("../Grafikai/6 lygis (6.2).png", "Lygis 6.2", -7, 8, 1, ["82%", "-46px", "16.3px", "40.5% 62%", ""], [2, 7], "D(t)=(2; 7]", 1, "(]"),
    new Graph("../Grafikai/7 lygis (7.0).png", "Lygis 7.0", -10, 4, 1, ["64.5%", "-17px", "16.55px", "12% 42%", "268f"], ["-∞", 3], "D(g)=(-∞; 3)", 1, "()"),
    new Graph("../Grafikai/7 lygis (7.1).png", "Lygis 7.1", -8, 10, 1, ["50.5%", "-20px", "8.25px", "14% 45.5%", "310f"], ["-∞", "+∞"], "D(h)=(-∞; +∞)", 1, "()"),
    new Graph("../Grafikai/7 lygis (7.2).png", "Lygis 7.2", -9, 9, 1, ["50.5%", "-45px", "10.8px", "12% 53%", "348f"], [-2, 2], "D(k)=[-2; 2]", 1, "[]"),
    new Graph("../Grafikai/8 lygis (8.0).png", "Lygis 8.0", -10, 8, 1, ["68%", "-23px", "9.15px", "47.3% 60%", "351t"], [-8, 5], "D(f)=[-8; 5]", 1, "[]"),
    new Graph("../Grafikai/8 lygis (8.1).png", "Lygis 8.1", -10, 9, 1, ["48%", "-36px", "7.6px", "15% 39%", "354t"], [-4, 4], "D(d)=[-4; 4]", 1, "[]"),
    new Graph("../Grafikai/8 lygis (8.2).png", "Lygis 8.2", -10, 12, 1, ["38.5%", "-3px", "2.95px", "10.5% 38.5%", "418t"], [-6, "+∞"], "D(t)=(-6; +∞)", 1, "()"),
    new Graph("../Grafikai/9 lygis (9.0.1).png", "Lygis 9.0.1", -9, 11, 1, ["50.5%", "-9px", "5.3px", "7% 47%", "322f"], [-3, 3], "D(s)=(-3; 3)", 1, "()"),
    new Graph("../Grafikai/9 lygis (9.0.2).png", "Lygis 9.0.2", -6, 6, 1, ["72.5%", "-52px", "24.1px", "30% 30%", "236t"], [-3, 2], "D(h)=[-3; 2)", 1, "[)"),
    new Graph("../Grafikai/9 lygis (9.1).png", "Lygis 9.1", -10, 12, 1, ["48%", "-7px", "2.9px", "9% 30%", "240f 269f 298t 327f 356f 385t 414f"], [-5, 5], "D(k)=[-5; 5)", 1, "[)"),
    new Graph("../Grafikai/9 lygis (9.2).png", "Lygis 9.2", -7, 10, 1, ["59%", "-46px", "11.7px", "10% 33%", "319t"], [-3, 5], "D(h)=(-3; 5)", 1, "()")
];
let explanations =
[
