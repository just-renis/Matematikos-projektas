...
[
    ...
    new Graph("../Grafikai/1 lygis (1.1).png", "Lygis 1.1", -12, 13, 1, 658, ["97%", "35%", "1.4%", "1%", "47.2%", "1.2%", "1.6px"], 10, [-3, 2], "-3;2", 1),
    new Graph("../Grafikai/1 lygis (1.2).png", "Lygis 1.2", -11, 10, 1, 648, ["95%", "47.8%", "3%", "0.8%", "47.2%", "3%", "5.6px"], 21, [-8, 4], "-8;4", 1),
    new Graph("../Grafikai/2 lygis (2.0).png", "Lygis 2.0", -10, 11, 1, 628, ["92%", "35.8%", "3.7%", "3%", "47.2%"], 26, [-5, 5], "[-5;5]", 1),
    new Graph("../Grafikai/2 lygis (2.1).png", "Lygis 2.1", -9, 9, 1, 628, ["92%", "42.2%", "3.8%", "2.9%", "47.2%"], 26.5, [0, 9], "[0;9]", 1),
    new Graph("../Grafikai/2 lygis (2.2).png", "Lygis 2.2", -8, 7, 1, 618, ["91%", "39%", "3.8%", "4.4%", "47.2%"], 26.5, [-0.5, 0.3], "[-0.5;0.3]", 10),
    new Graph("../Grafikai/3 lygis (3.0).png", "Lygis 3.0", -7, 9, 1, 648, ["95%", "42.5%", "1.8%", "2%", "47.2%"], 13, [-1, 1], "(-1;1]", 1),
    new Graph("../Grafikai/3 lygis (3.1).png", "Lygis 3.1", -9, 12, 1, 630, ["93%", "41.3%", "4.2%", "2.3%", "47.2%"], 29, [-6, 7], "(-6;7)", 1),
    new Graph("../Grafikai/3 lygis (3.2).png", "Lygis 3.2", -55, 60, 5, 642, ["94%", "37.5%", "3%", "1.8%", "47.2%"], 21, [-40, 20], "(-40;20)", 1),
    ...
    new Graph("../Grafikai/4 lygis (4.1).png", "Lygis 4.1", -9, 10, 1, 638, ["94%", "61%", "2%", "3.2%", "83.6%"], 14, ["-∞", 2], "(-∞;2]", 1),
    new Graph("../Grafikai/4 lygis (4.2).png", "Lygis 4.2", -12, 16, 1, 648, ["95%", "57%", "1.4%", "2.4%", "78%"], 10, ["-∞", "∞"], "(-∞;∞)", 1),
    ...
    new Graph("../Grafikai/5 lygis (5.2).png", "Lygis 5.2", -9, 13, 1, 638, ["94%", "43.7%", "3.8%", "1.5%", "59.4%"], 27, [-6, 9], "D(t)=(-6;9]", 1),
    new Graph("../Grafikai/6 lygis (6.0).png", "Lygis 6.0", -9, 9, 1, 632, ["93%", "14.2%", "5%", "1.1%", "18.1%"], 35, [-3, 3], "D(h)=[-3;3]", 1),
    new Graph("../Grafikai/6 lygis (6.1).png", "Lygis 6.1", -20, 8, 2, 648, ["95%", "53.8%", "1%", "2.8%", "73.5%"], 7, [-10, -2], "D(g)=[-10;-2]", 1),
    new Graph("../Grafikai/6 lygis (6.2).png", "Lygis 6.2", -7, 8, 1, 635, ["94%", "60%", "1.7%", "4%", "82.3%"], 12, [2, 7], "D(t)=(2;7]", 1),
    new Graph("../Grafikai/7 lygis (7.0).png", "Lygis 7.0", -10, 4, 1, 600, ["89%", "47.4%", "5.7%", "5%", "64.7%"], 40, ["-∞", 3], "D(g)=(-∞;3)", 1),
    new Graph("../Grafikai/7 lygis (7.1).png", "Lygis 7.1", -8, 10, 1, 615, ["91%", "37.3%", "3.7%", "4.8%", "50.5%"], 26, ["-∞", "∞"], "D(h)=(-∞;∞)", 1),
    new Graph("../Grafikai/7 lygis (7.2).png", "Lygis 7.2", -9, 9, 1, 655, ["96%", "37.4%", "1%", "1.9%", "50.7%"], 7, [-2, 2], "D(k)=[-2;2]", 1),
    new Graph("../Grafikai/8 lygis (8.0).png", "Lygis 8.0", -10, 8, 1, 633, ["93%", "49.9%", "3%", "3%", "68%"], 21, [-8, 5], "D(f)=[-8;5]", 1),
    new Graph("../Grafikai/8 lygis (8.1).png", "Lygis 8.1", -10, 9, 1, 639, ["94%", "35.6%", "1%", "4.1%", "48%"], 7, [-4, 4], "D(d)=[-4;4]", 1),
    new Graph("../Grafikai/8 lygis (8.2).png", "Lygis 8.2", -10, 12, 1, 635, ["94%", "28.8%", "4.3%", "1.5%", "38.5%"], 30, [-6, "∞"], "D(t)=(-6;∞)", 1),
    ...
    new Graph("../Grafikai/9 lygis (9.1).png", "Lygis 9.1", -10, 12, 1, 633, ["94%", "35.6%", "3.8%", "2.2%", "48%"], 27, [-5, 5], "D(k)=[-5;5)", 1),
    new Graph("../Grafikai/9 lygis (9.2).png", "Lygis 9.2", -7, 10, 1, 637, ["94%", "43.5%", "0.9%", "4.6%", "59%"], 6, [-3, 5], "D(h)=(-3;5)", 1)
];
let explanations =
[
