...
[
    ...
    new Graph("../Grafikai/2 lygis (2.1).png", "Lygis 2.1", -9, 9, 1, 625, ["92%", "42.2%", "3.8%", "2.9%", "47.2%", "2.5%", "10px"], 26.5, [0, 9], "[0; 9]", 1),
    ...
    new Graph("../Grafikai/5 lygis (5.0).png", "Lygis 5.0", -45, 45, 5, 638, ["95%", "22.3%", "1%", "4.3%", "29.5%"], 7, [-10, 30], "g[-10; 30)", 1),
    new Graph("../Grafikai/5 lygis (5.1).png", "Lygis 5.1", -12, 10, 1, 638, ["95%", "45.7%", "3.3%", "2%", "62.2%", "2.5%", "4.2px"], 23, ["-∞", 4], "h(-∞; 4]", 1),
    new Graph("../Grafikai/5 lygis (5.2).png", "Lygis 5.2", -9, 13, 1, 638, ["94%", "43.7%", "3.8%", "1.5%", "59.4%", "3.1%", "4.2px"], 27, [-6, 9], "t(-6; 9]", 1),
